  ...
  $(function() {
    ...
    if ($("#balance-chart").length) {
      var areaData = {
        ...
        datasets: [
          {
            data: [26.00, 14.00, 22.00, 12.00, 23.00, 24.00, 27.00, 12.00, 28.00, 26.00, 12.50, 19.00, 18.00, 28.00, 28.00, 12.00, 25.00, 26.00, 18.00, 12.00, 20.00, 18.00, 27.00, 16.00, 28.00, 20.00, 21.00, 12.00, 20.00, 12.00, 12.00, 25.00],
            borderColor: [
              '#1faf47'
            ],
            borderWidth: 3,
